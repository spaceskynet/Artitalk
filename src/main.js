...
atEvery.prototype.seeContent=function(pageNum,option){
    ...
    query.find().then(function (shuoContent){
        ...
        shuoContent.forEach(function(atContent){
            ...
            let contengMid = "<li><span class=\"cbp_tmlabel\" id='atId"+id+"' ><div " + hideIcon + "id='operate"+id+"'  class=\"delete_right\"><svg t=\"1591347978744\"  viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"14459\" width=\"20\" height=\"20\" style=\"display: inline\"  onclick=\"atEvery.prototype.delete('"+id+"')\"  ><path d=\"M512 883.2A371.2 371.2 0 1 0 140.8 512 371.2 371.2 0 0 0 512 883.2z m0 64a435.2 435.2 0 1 1 435.2-435.2 435.2 435.2 0 0 1-435.2 435.2z\" p-id=\"14460\" fill=\"" + color3 + "\"></path><path d=\"M557.056 512l122.368 122.368a31.744 31.744 0 1 1-45.056 45.056L512 557.056l-122.368 122.368a31.744 31.744 0 1 1-45.056-45.056L466.944 512 344.576 389.632a31.744 31.744 0 1 1 45.056-45.056L512 466.944l122.368-122.368a31.744 31.744 0 1 1 45.056 45.056z\" p-id=\"14461\" fill=\"" + color3 + "\"></path></svg></div><div id='forEdit"+id+"'>" + quoteSvg +  shuoshuoPerContent + "</div><div class=\"shuoshuo_time\"><span class=\"shuoshuo_author_img\" onclick='atEvery.prototype.atEdit(\""+id+"\")'><img  id='atAvatar"+id+"'  src=\"" + shuoAvatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span>" + "<div class=\"shuoshuo_info\"><span>" + userName +  "</span><br/><span style=\"\"> " + " " + osSvg + atOs + "</span><span>&nbsp&nbsp" + timeSvg + resDate + " " + resTime + "" + "</span></div><span id='shuoshuo_comment'><span style='"+atCommentTrue+";vertical-align:top;' onclick='atEvery.prototype.commentInit(\""+id+"\")'  id='atCoInit"+id+"'>"+commentSvg+"<span style='padding: 0 0 0 8px;color:"+color3+"'; id= 'coValue"+id+"'>loading</span></span>&nbsp<span style='vertical-align:top;' id='"+id+"'></span></div></span></li>";
            mid += contengMid;
        })  
        ...
        if (shuoNum === 0 && pageNum === 0) {
            originString = "<ul class=\"cbp_tmtimeline\" id=\"maina\"><li><span class=\"cbp_tmlabel\"><div></div><div>" + text24 + "</div><div class=\"shuoshuo_time\"><span class=\"shuoshuo_author_img\"><img src=\"https://cdn.jsdelivr.net/gh/drew233/cdn/logol.png\" class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span><div class=\"shuoshuo_info\"><span style=\"\"> 由Artitalk发表</span></div><span><svg t=\"1591350675688\"  viewBox=\"0 0 1025 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"28653\" width=\"10\" height=\"10\" style=\"display: inline\"></svg> 2020-04-10 20:35:25</span></div></span></li></ul>";
        }
    ...
    atEvery.prototype.commentInit = function(id,option){
        ...
        let originString = "<ul class=\"cbp_tmtimeline\" id=\"maina\"><li><span class=\"cbp_tmlabel\">"+originShuo+"</p></span></li></ul>";
        document.getElementById('ccontent').innerHTML = originString;    
        let mid="";        
        let currentUser = AV.User.current();
        ...
        commentQuery.find().then(res => {
            res.forEach(function(comment){
                ...
                let comList = "<li style=\"margin: 0 0 0 48px\"><span class=\"cbp_tmlabel\"  ><div></div><div>" + comContent + "</div><div class=\"shuoshuo_time\"><span class=\"shuoshuo_author_img\"><img src=\"" + comAvatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span>" + "<span>" + commentNick + "</span><span>&nbsp&nbsp" + timeSvg + resDate + " " + resTime + replySvg + "</span></div></span></li>";
                mid += comList;
            })
            let originString = document.getElementById('ccontent').innerHTML;
            originString = originString.replace(/(.*)<\/ul>/,'$1 ');
