    ...
    atEvery.prototype.commentInit = function(id,option){
        ...
        commentQuery.find().then(res => {
            res.forEach(function(comment){
                ...
                let comList = "<li style=\"margin: 0 0 2rem 3rem\"><span class=\"cbp_tmlabel\"  ><div></div><div>" + comContent + "</div><div class=\"shuoshuo_time\"><span class=\"shuoshuo_author_img\"><img src=\"" + comAvatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span>" + "<div class=\"shuoshuo_info\"><span>" + commentNick + "</span><br/><span>" + timeSvg + resDate + " " + resTime + "</span></div>"+ replySvg + "</div></span></li>";
                mid += comList;
            })
            let originString = document.getElementById('ccontent').innerHTML;
            originString = originString.replace(/(.*)<\/ul>/,'$1 ');
