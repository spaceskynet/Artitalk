    ...
    atEvery.prototype.commentInit = function(id,option){
        ...
        commentQuery.find().then(res => {
            res.forEach(function(comment){
                ...
                let comList = "<li style=\"margin: 0 0 0 48px\"><span class=\"cbp_tmlabel\"  >  <div>" + comContent + "</div><div class=\"shuoshuo_time\"><span class=\"shuoshuo_author_img\"><img src=\"" + comAvatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span>" + "<span>" + commentNick + "</span><span>&nbsp&nbsp" + timeSvg + resDate + " " + resTime + replySvg + "</span></div></span></li>";
                mid += comList;
            })
            let originString = document.getElementById('ccontent').innerHTML;
            originString = originString.replace(/(.*)<\/ul>/,'$1 ');
